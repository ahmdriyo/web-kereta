...
const AddKereta = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    if  (addData.namaKereta.trim() !== "" && addData.kelas.trim() !== "" && addData.destinasi.trim() !== "")  {
      try {
      ...
      <div className="flex items-center justify-center h-full">
        <div className="bg-[#eedef8] bg-opacity-75 backdrop-filter backdrop-blur-sm p-6 rounded shadow-md w-[500px]">
          ...
          <h3 className="font-bold text-xl mb-5">Input Kereta</h3>
            ...
            type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Simpan</button>
          </form>
        </div>
      </div>
    </div>
